 ...
 * @author sllxgmm
 * @version 1.0
 * @描述 <h1> HealthCheck </h1>
 * @date 2020/3/15 18:51
...
public class HealthCheck {
    ...
    @Autowired
    public HealthCheck(DiscoveryClient client,
    ...
    /**
     * <h2>健康检查接口</h2>
     * 127.0.0.1:7000/coupon-template/health
     * */
    @GetMapping("/health")
    ...
    /**
     * <h2>异常测试接口</h2>
     * 127.0.0.1:7000/coupon-template/exception
     * */
     ...
     * 127.0.0.1:7000/coupon-template/info
     * */
    @GetMapping("/info")
